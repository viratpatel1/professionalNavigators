...
function TestimonialSection() {
    const testimonials = [
        {
            name: "Shagun Sharma",
            feedback: "Best classes for CA students. The way the teachers explain with concept clarity is amazing. One of the best things is the real-life examples the teachers give and the notes are really amazing too."
        },
        {
            name: "Manjinder Singh",
            feedback: "I really enjoyed the online course Professional Navigator classes. All the facilities are so good. All the teachers motivate the students to crack the exam and it should really help us. All in all teaching style and education provided by teachers are more effective and excellent."
        },
        {
            name: "Gautam Miglani",
            feedback: "I’m a CA Intermediate student. I came across the Best Faculty for CA course which Professional Navigator Classes. I am extremely satisfied with the quality of classes. Moreover, prices are affordable too."
        }
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d5f2643._.js.map